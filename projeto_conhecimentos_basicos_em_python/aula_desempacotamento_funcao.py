...
print("\nDesempacotamento comum")
primeiro, segundo, *_, terceiro, quarto = lista
...
print(*dicionario.items()) # mostra tuplas -> ('nome', 'Renan') ('sobrenome', 'Alves')
print(*dicionario.values()) # mostra só os valores -> Renan Alves
