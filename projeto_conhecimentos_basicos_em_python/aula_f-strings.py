...
print(f"{reais:0=+20,.2f}")  # preenche com zeros, força o sinal, com 20 caracteres, separador de milhar e 2 casas decimais
print(f"{reais:0=+30,.2f}")  # preenche com zeros, força o sinal, com 30 caracteres, separador de milhar e 2 casas decimais
