...
# Método count() de strings, ajuda a contar quantas vezes uma letra ou palavra aparece em uma string
# Sintaxe: string.count(substring) -> retorna o número de ocorrências da substring na string
