...
Na Engenharia de Software, a **Herança Mútipla** ocorre quando uma classe filha derivada de ***duas ou mais superclasses***. O Python é uma das poucas linguagens modernas(ao contrário de Java ou C#) que suporta esse recurso de forma nativa e robusta.
